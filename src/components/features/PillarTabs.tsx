...
export function PillarTabs() {
  ...
  const content = {
    logistics: {
      ...
      clients: [{ name: "Uber", logo: "/Logos/Uber.jpg" },
      { name: "Rapiod", logo: "/Logos/Rapido.jpg" },
      { name: "Zepto", logo: "/Logos/Zepto.jpg" },
      { name: "Amazon", logo: "/Logos/Amazon.jpg" },
      { name: "Flipkart", logo: "/Logos/Flipkart.jpg" },
      { name: "Zomato", logo: "/Logos/Zomato.jpg" },
      { name: "Swiggy", logo: "/Logos/Swiggy.jpg" },
      { name: "Blinkit", logo: "/Logos/Blinkit.jpg" },
      { name: "SBI", logo: "/Logos/SBI.jpg" },
      { name: "ICICI", logo: "/Logos/ICICI.jpg" },
      ],
    },
    enterprise: {
