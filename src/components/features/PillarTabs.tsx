...
export function PillarTabs() {
  ...
  const content = {
    logistics: {
      ...
      clients: [{ name: "Uber", logo: "/asserts/logos/Uber.jpg" },
      { name: "Rapiod", logo: "/asserts/logos/Rapido.jpg" },
      { name: "Zepto", logo: "/asserts/logos/Zepto.jpg" },
      { name: "Amazon", logo: "/asserts/logos/Amazon.jpg" },
      { name: "Flipkart", logo: "/asserts/logos/Flipkart.jpg" },
      { name: "Zomato", logo: "/asserts/logos/Zomato.jpg" },
      { name: "Swiggy", logo: "/asserts/logos/Swiggy.jpg" },
      { name: "Blinkit", logo: "/asserts/logos/Blinkit.jpg" },
      { name: "SBI", logo: "/asserts/logos/SBI.jpg" },
      { name: "ICICI", logo: "/asserts/logos/ICICI.jpg" },
      ],
    },
    enterprise: {
