...
export function PillarTabs() {
  ...
  const content = {
    logistics: {
      ...
      clients: [{ name: "Uber", logo: "/assests/logos/Uber.jpg" },
      { name: "Rapiod", logo: "/assests/logos/Rapido.jpg" },
      { name: "Zepto", logo: "/assests/logos/Zepto.jpg" },
      { name: "Amazon", logo: "/assests/logos/Amazon.jpg" },
      { name: "Flipkart", logo: "/assests/logos/Flipkart.jpg" },
      { name: "Zomato", logo: "/assests/logos/Zomato.jpg" },
      { name: "Swiggy", logo: "/assests/logos/Swiggy.jpg" },
      { name: "Blinkit", logo: "/assests/logos/Blinkit.jpg" },
      { name: "SBI", logo: "/assests/logos/SBI.jpg" },
      { name: "ICICI", logo: "/assests/logos/ICICI.jpg" },
      ],
    },
    enterprise: {
